...
python -u train_il.py reset_step=true \
agent.cilrs.wb_run_path=vaydingul/il_leaderboard_roach/35a3mrcz agent.cilrs.wb_ckpt_step=29 \
wb_project="il_leaderboard_roach" wb_group="train_trajectory_with_target_waypoint_new_data" 'wb_name="Trajectory Branch - Control Branch (LR Scheduled)"' \
