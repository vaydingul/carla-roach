...
agent.cilrs.wb_run_path=vaydingul/il_leaderboard_roach/38gm3xqe agent.cilrs.wb_ckpt_step=29 \
wb_project="il_leaderboard_roach" wb_group="train_trajectory_with_target_waypoint_new_data" 'wb_name="Trajectory Branch - Temporal Module (LR Scheduled)"' \
