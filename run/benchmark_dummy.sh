...
# * To benchmark il agents.
 ...
 benchmark () {
   ...
   wb_project=iccv21-roach-benchmark \
   agent=$agent actors.hero.agent=$agent \
   agent.cilrs.wb_run_path=iccv21-roach/trained-models/12uzu2lu \
   'wb_group="L_K CLUSTER TEST"' \
   'wb_notes="Benchmark L_K on Leaderboard New Weather/ New Town. (FOR CLUSTER TEST)"' \
