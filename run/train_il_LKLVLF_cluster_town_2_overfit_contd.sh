...
agent.cilrs.wb_run_path=vaydingul/il_leaderboard_roach/2or2hz57 agent.cilrs.wb_ckpt_step=24 \
wb_project="il_leaderboard_roach" wb_group="train_from_scratch" 'wb_name="L_K+L_V+L_F(c) Town02 Overfit contd"' \
dagger_datasets=["/scratch/users/vaydingul20/new_dataset_carla_9_10_1_town_02/"] \
agent.cilrs.env_wrapper.kwargs.input_states=[speed,vec,cmd] \
agent.cilrs.policy.kwargs.number_of_branches=1 \
agent.cilrs.training.kwargs.branch_weights=[1.0] \
agent.cilrs.env_wrapper.kwargs.action_distribution="beta_shared" \
...
CACHE_DIR="/scratch/users/vaydingul20/new_dataset_carla_9_10_1_town_02/"
